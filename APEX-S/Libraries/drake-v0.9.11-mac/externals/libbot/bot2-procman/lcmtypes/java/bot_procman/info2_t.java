...
public final class info2_t implements lcm.lcm.LCMEncodable
{
    public long utime;
    public String host;
    ...
    public int ncmds;
    public bot_procman.deputy_cmd2_t cmds[];
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x594fec8cdb8bc81cL;
    ...
    {
        if (classes.contains(bot_procman.info2_t.class))
            return 0L;
 
        classes.add(bot_procman.info2_t.class);
        long hash = LCM_FINGERPRINT_BASE
             + bot_procman.deputy_cmd2_t._hashRecursive(classes)
            ;
    ...
    public info2_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public info2_t(DataInput ins) throws IOException
    {
    ...
    public static bot_procman.info2_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        bot_procman.info2_t o = new bot_procman.info2_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.cmds = new bot_procman.deputy_cmd2_t[(int) ncmds];
        for (int a = 0; a < this.ncmds; a++) {
            this.cmds[a] = bot_procman.deputy_cmd2_t._decodeRecursiveFactory(ins);
        }
    ...
    public bot_procman.info2_t copy()
    {
        bot_procman.info2_t outobj = new bot_procman.info2_t();
        ...
        outobj.cmds = new bot_procman.deputy_cmd2_t[(int) ncmds];
        for (int a = 0; a < this.ncmds; a++) {
