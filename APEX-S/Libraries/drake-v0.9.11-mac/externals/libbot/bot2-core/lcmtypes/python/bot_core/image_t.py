...
class image_t(object):
    ...
    def _decode_one(buf):
        ...
        self.metadata = []
        for i0 in range(self.nmetadata):
            self.metadata.append(image_metadata_t.image_metadata_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x6fee6cb20472ff6a+ image_metadata_t.image_metadata_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
