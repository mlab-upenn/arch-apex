...
typedef void(*bot_procman_command2_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const bot_procman_command2_t *msg, void *user);

int bot_procman_command2_t_publish(lcm_t *lcm, const char *channel, const bot_procman_command2_t *p);
bot_procman_command2_t_subscription_t* bot_procman_command2_t_subscribe(lcm_t *lcm, const char *channel, bot_procman_command2_t_handler_t f, void *userdata);
