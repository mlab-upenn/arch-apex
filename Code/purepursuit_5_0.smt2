...
(declare-fun Psi_init_4_0 () Real)
(declare-fun Psi_init_4_t () Real)
(declare-fun Psi_init_5_0 () Real)
(declare-fun Psi_init_5_t () Real)
...
(define-ode flow_1 ((= d/dt[Beta] (- (+ (* (- (/ (- (* 108000 1.515) (* 108000 1.292)) (* (* 2273 v) v)) 1) Psi_dot) (/ (* 108000 (/ (* 2 (sin (- 3.14159 (^ (^ (- (^ (^ (- Psi_init (arctan (/ (- (^ (+ (^ (- waypointx sx_0) 2) (^ (- waypointy sy_0) 2)) 0.5) x) y))) 2) 0.5) 3.14159) 2) 0.5)))) (^ (+ (* (- waypointx sx_0) (- waypointx sx_0)) (* (- waypointy sy_0) (- waypointy sy_0))) 0.5))) (* 2273 v))) (/ (* (+ 108000 108000) Beta) (* 2273 v)))) (= d/dt[Psi] Psi_dot) (= d/dt[Psi_d_spline] 0) (= d/dt[Psi_dot] (+ (- (/ (* (- (* 108000 1.515) (* 108000 1.292)) Beta) 4423) (* (/ (+ (* (* 1.292 1.292) 108000) (* (* 1.515 1.515) 108000)) 4423) (/ Psi_dot v))) (/ (* (* 1.292 108000) (/ (* 2 (sin (- 3.14159 (^ (^ (- (^ (^ (- Psi_init (arctan (/ (- (^ (+ (^ (- waypointx sx_0) 2) (^ (- waypointy sy_0) 2)) 0.5) x) y))) 2) 0.5) 3.14159) 2) 0.5)))) (^ (+ (* (- waypointx sx_0) (- waypointx sx_0)) (* (- waypointy sy_0) (- waypointy sy_0))) 0.5))) 4423))) (= d/dt[Psi_dot_d_spline] 0) (= d/dt[Psi_init] 0) (= d/dt[kappa_d_spline] 0) (= d/dt[lookahead] 0) (= d/dt[schedtime] 1) (= d/dt[simtime] 0) (= d/dt[sx] (* v (cos (+ Beta Psi)))) (= d/dt[sx_0] 0) (= d/dt[sx_d_spline] 0) (= d/dt[sy] (* v (sin (+ Beta Psi)))) (= d/dt[sy_0] 0) (= d/dt[sy_d_spline] 0) (= d/dt[tau] 1) (= d/dt[v] (* 10 (- 11.11 v))) (= d/dt[waypointx] 0) (= d/dt[waypointy] 0)))
...
(assert (<= -5 Psi_init_4_0))
(assert (<= Psi_init_4_0 5))
(assert (<= -5 Psi_init_4_t))
(assert (<= Psi_init_4_t 5))
(assert (<= -5 Psi_init_5_0))
(assert (<= Psi_init_5_0 5))
(assert (<= -5 Psi_init_5_t))
(assert (<= Psi_init_5_t 5))
...
(assert (<= time_4 4 [0.000000]))
(assert (<= 0 time_5 [0.000000]))
(assert (<= time_5 4 [0.000000]))
(assert (<= 1 mode_0))
(assert (<= mode_0 2))
(assert (<= 1 mode_1))
(assert (<= mode_1 2))
