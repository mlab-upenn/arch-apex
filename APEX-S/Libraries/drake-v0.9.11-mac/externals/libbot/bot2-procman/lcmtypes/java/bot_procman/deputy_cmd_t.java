...
public final class deputy_cmd_t implements lcm.lcm.LCMEncodable
{
    public String name;
    ...
    public static final long LCM_FINGERPRINT_BASE = 0xed5fbe5982ac8353L;
    ...
    {
        if (classes.contains(bot_procman.deputy_cmd_t.class))
            return 0L;
 
        classes.add(bot_procman.deputy_cmd_t.class);
    ...
    public deputy_cmd_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public deputy_cmd_t(DataInput ins) throws IOException
    {
    ...
    public static bot_procman.deputy_cmd_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        bot_procman.deputy_cmd_t o = new bot_procman.deputy_cmd_t();
    ...
    public bot_procman.deputy_cmd_t copy()
    {
        bot_procman.deputy_cmd_t outobj = new bot_procman.deputy_cmd_t();
