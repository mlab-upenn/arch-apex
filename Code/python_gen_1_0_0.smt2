...
(declare-fun sx () Real)
(declare-fun noise () Real [0.200000])
...
(declare-fun vx_env_0_0 () Real)
(declare-fun vx_env_0_t () Real)
...
(declare-fun noise_0_0 () Real [0.200000])
(declare-fun noise_0_t () Real [0.200000])
...
(define-ode flow_1 ((= d/dt[Beta] (- (+ (* (- (/ (- (* 108000 1.515) (* 108000 1.292)) (* (* 2273 v) v)) 1) Psi_dot) (/ (* 108000 delta) (* 2273 v))) (/ (* (+ 108000 108000) Beta) (* 2273 v)))) (= d/dt[Psi] Psi_dot) (= d/dt[Psi_d] (* 11.11 kappa_d)) (= d/dt[Psi_dot] (+ (- (/ (* (- (* 108000 1.515) (* 108000 1.292)) Beta) 4423) (* (/ (+ (* (* 1.292 1.292) 108000) (* (* 1.515 1.515) 108000)) 4423) (/ Psi_dot v))) (/ (* (* 1.292 108000) delta) 4423))) (= d/dt[Psi_dot_d] (* 11.11 (+ (+ (* (/ (* -0.5 (+ (- (+ (* -2 0) (* 11 0)) (* 18 0.033194)) (* 9 -0.033194))) 22.6819) 11.11) (* (* (* (* 2 (/ (* 4.5 (+ (- (+ 0 (* 2 0)) (* 5 0.033194)) (* 4 -0.033194))) (* 22.6819 22.6819))) 11.11) 11.11) tau)) (* (* (* (* (* (* 3 (/ (* -4.5 (+ (- (+ 0 0) (* 3 0.033194)) (* 3 -0.033194))) (* (* 22.6819 22.6819) 22.6819))) 11.11) 11.11) 11.11) tau) tau)))) (= d/dt[delta] (- (+ (+ (* 2 (- (* (cos Psi_d) (- sy_d sy)) (* (sin Psi_d) (- sx_d sx)))) (* 12 (- Psi_d Psi))) (* 4 (- Psi_dot_d Psi_dot))) (* 2 delta))) (= d/dt[kappa_d] (+ (+ (* (/ (* -0.5 (+ (- (+ (* -2 0) (* 11 0)) (* 18 0.033194)) (* 9 -0.033194))) 22.6819) 11.11) (* (* (* (* 2 (/ (* 4.5 (+ (- (+ 0 (* 2 0)) (* 5 0.033194)) (* 4 -0.033194))) (* 22.6819 22.6819))) 11.11) 11.11) tau)) (* (* (* (* (* (* 3 (/ (* -4.5 (+ (- (+ 0 0) (* 3 0.033194)) (* 3 -0.033194))) (* (* 22.6819 22.6819) 22.6819))) 11.11) 11.11) 11.11) tau) tau))) (= d/dt[noise] 0) (= d/dt[sx] (* v (cos (+ Beta Psi)))) (= d/dt[sx_d] (* 11.11 (cos Psi_d))) (= d/dt[sx_env] vx_env) (= d/dt[sy] (* v (sin (+ Beta Psi)))) (= d/dt[sy_d] (* 11.11 (sin Psi_d))) (= d/dt[tau] 1) (= d/dt[v] (+ (* 1 (+ (* (cos Psi_d) (- sx_d sx)) (* (sin Psi_d) (- sy_d sy)))) (* 10 (- 11.11 v)))) (= d/dt[vx_env] noise)))
(assert (<= 0 vx_env_0_0))
(assert (<= vx_env_0_0 100))
(assert (<= 0 vx_env_0_t))
(assert (<= vx_env_0_t 100))
(assert (<= 6 v_0_0))
(assert (<= v_0_0 12))
(assert (<= 6 v_0_t))
(assert (<= v_0_t 12))
...
(assert (<= sy_0_t 10))
(assert (<= 0 sx_env_0_0))
(assert (<= sx_env_0_0 100))
(assert (<= 0 sx_env_0_t))
(assert (<= sx_env_0_t 100))
(assert (<= 0 sx_d_0_0))
(assert (<= sx_d_0_0 50))
(assert (<= 0 sx_d_0_t))
(assert (<= sx_d_0_t 50))
...
(assert (<= sx_0_t 50))
(assert (<= 0 noise_0_0))
(assert (<= noise_0_0 0.1))
(assert (<= 0 noise_0_t))
(assert (<= noise_0_t 0.1))
...
(assert (<= 1 mode_0))
(assert (<= mode_0 1))
(assert (and (and (= vx_env_0_0 0) (= kappa_d_0_0 0) (= sx_env_0_0 19.439) (= Psi_dot_d_0_0 0) (= Psi_d_0_0 0) (= tau_0_0 0) (= delta_0_0 0) (= Beta_0_0 0) (= Psi_dot_0_0 0) (<= Psi_0_0 0.05) (>= Psi_0_0 0) (= sy_d_0_0 0) (= sx_d_0_0 0) (= v_0_0 11.1) (>= v_0_0 10.9) (<= sy_0_0 0.1) (>= sy_0_0 0) (<= sx_0_0 0.1) (>= sx_0_0 0)) (= mode_0 1) (= tau_0_t (+ tau_0_0 (* 1 time_0))) (= noise_0_t (+ noise_0_0 (* 0 time_0))) (= [Beta_0_t Psi_0_t Psi_d_0_t Psi_dot_0_t Psi_dot_d_0_t delta_0_t kappa_d_0_t noise_0_t sx_0_t sx_d_0_t sx_env_0_t sy_0_t sy_d_0_t tau_0_t v_0_t vx_env_0_t] (integral 0. time_0 [Beta_0_0 Psi_0_0 Psi_d_0_0 Psi_dot_0_0 Psi_dot_d_0_0 delta_0_0 kappa_d_0_0 noise_0_0 sx_0_0 sx_d_0_0 sx_env_0_0 sy_0_0 sy_d_0_0 tau_0_0 v_0_0 vx_env_0_0] flow_1)) (= mode_0 1) (forall_t 1 [0 time_0] (>= sx_0_t 0)) (>= sx_0_t 0) (>= sx_0_0 0) (forall_t 1 [0 time_0] (>= v_0_t 0)) (>= v_0_t 0) (>= v_0_0 0) (= mode_0 1) (> sx_0_t sx_env_0_t) (< sy_0_t 3.7)))
(check-sat)
(exit)
