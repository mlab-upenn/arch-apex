...
class lcmt_piecewise_polynomial(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_segments):
            assert self.polynomial_matrices[i0]._get_packed_fingerprint() == lcmt_polynomial_matrix.lcmt_polynomial_matrix._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.polynomial_matrices = []
        for i0 in range(self.num_segments):
            self.polynomial_matrices.append(lcmt_polynomial_matrix.lcmt_polynomial_matrix._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x6392ab0e78c32254+ lcmt_polynomial_matrix.lcmt_polynomial_matrix._get_hash_recursive(newparents)) & 0xffffffffffffffff
