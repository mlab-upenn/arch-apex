...
import lcmt_support_data

import lcmt_body_wrench_data

import lcmt_zmp_data

import lcmt_whole_body_data

import lcmt_body_motion_data

import lcmt_joint_pd_override
...
class lcmt_qp_controller_input(object):
    ...
    def _encode_one(self, buf):
        ...
        assert self.zmp_data._get_packed_fingerprint() == lcmt_zmp_data.lcmt_zmp_data._get_packed_fingerprint()
        self.zmp_data._encode_one(buf)
        buf.write(struct.pack(">i", self.num_support_data))
        for i0 in range(self.num_support_data):
            assert self.support_data[i0]._get_packed_fingerprint() == lcmt_support_data.lcmt_support_data._get_packed_fingerprint()
        ...
        for i0 in range(self.num_tracked_bodies):
            assert self.body_motion_data[i0]._get_packed_fingerprint() == lcmt_body_motion_data.lcmt_body_motion_data._get_packed_fingerprint()
        ...
        for i0 in range(self.num_external_wrenches):
            assert self.body_wrench_data[i0]._get_packed_fingerprint() == lcmt_body_wrench_data.lcmt_body_wrench_data._get_packed_fingerprint()
            self.body_wrench_data[i0]._encode_one(buf)
        assert self.whole_body_data._get_packed_fingerprint() == lcmt_whole_body_data.lcmt_whole_body_data._get_packed_fingerprint()
        ...
        for i0 in range(self.num_joint_pd_overrides):
            assert self.joint_pd_override[i0]._get_packed_fingerprint() == lcmt_joint_pd_override.lcmt_joint_pd_override._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.be_silent, self.timestamp = struct.unpack(">bq", buf.read(9))
        self.zmp_data = lcmt_zmp_data.lcmt_zmp_data._decode_one(buf)
        self.num_support_data = struct.unpack(">i", buf.read(4))[0]
        self.support_data = []
        for i0 in range(self.num_support_data):
            self.support_data.append(lcmt_support_data.lcmt_support_data._decode_one(buf))
        self.num_tracked_bodies = struct.unpack(">i", buf.read(4))[0]
        self.body_motion_data = []
        for i0 in range(self.num_tracked_bodies):
            self.body_motion_data.append(lcmt_body_motion_data.lcmt_body_motion_data._decode_one(buf))
        self.num_external_wrenches = struct.unpack(">i", buf.read(4))[0]
        self.body_wrench_data = []
        for i0 in range(self.num_external_wrenches):
            self.body_wrench_data.append(lcmt_body_wrench_data.lcmt_body_wrench_data._decode_one(buf))
        self.whole_body_data = lcmt_whole_body_data.lcmt_whole_body_data._decode_one(buf)
        self.num_joint_pd_overrides = struct.unpack(">i", buf.read(4))[0]
        self.joint_pd_override = []
        for i0 in range(self.num_joint_pd_overrides):
            self.joint_pd_override.append(lcmt_joint_pd_override.lcmt_joint_pd_override._decode_one(buf))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x10daf84344767104+ lcmt_zmp_data.lcmt_zmp_data._get_hash_recursive(newparents)+ lcmt_support_data.lcmt_support_data._get_hash_recursive(newparents)+ lcmt_body_motion_data.lcmt_body_motion_data._get_hash_recursive(newparents)+ lcmt_body_wrench_data.lcmt_body_wrench_data._get_hash_recursive(newparents)+ lcmt_whole_body_data.lcmt_whole_body_data._get_hash_recursive(newparents)+ lcmt_joint_pd_override.lcmt_joint_pd_override._get_hash_recursive(newparents)) & 0xffffffffffffffff
