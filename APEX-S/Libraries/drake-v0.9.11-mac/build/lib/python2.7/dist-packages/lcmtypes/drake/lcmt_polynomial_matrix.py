...
class lcmt_polynomial_matrix(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.rows):
            for i1 in range(self.cols):
                assert self.polynomials[i0][i1]._get_packed_fingerprint() == lcmt_polynomial.lcmt_polynomial._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        for i0 in range(self.rows):
            ...
            for i1 in range(self.cols):
                self.polynomials[i0].append(lcmt_polynomial.lcmt_polynomial._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xb7c3cad59f376c2d+ lcmt_polynomial.lcmt_polynomial._get_hash_recursive(newparents)) & 0xffffffffffffffff
