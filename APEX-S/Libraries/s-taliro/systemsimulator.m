...
%         UPoint: e.g. f inputSignal1 has 2 control pnts, and inputSignal2 has 3
...
%      
%     rc 
%         Return code. Because systemsimulator migth call system-defined simulators, the values vary, but always obey the
%         rule that 0 means 'everything is OK', and a negative value means 'something went wrong'. Positive values mean
%         different good or neutral things.  In particular,
%         -3 means simulation errored, output is junk.
%     
...
elseif strcmp(inputModelType, 'hautomaton')  
    ...
    % If you're asverstising yourself as a hautomaton, then your h0 will contain the initial location and simulation time.
