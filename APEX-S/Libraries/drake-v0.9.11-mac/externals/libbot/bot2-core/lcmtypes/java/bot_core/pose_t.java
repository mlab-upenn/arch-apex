...
public final class pose_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(bot_core.pose_t.class))
            return 0L;
 
        classes.add(bot_core.pose_t.class);
    ...
    public static bot_core.pose_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
