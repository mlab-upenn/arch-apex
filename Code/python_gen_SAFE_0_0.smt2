...
(assert (<= 1 mode_0))
(assert (<= mode_0 1))
(assert (and (and (= kappa_d_0_0 0) (= sx_env_0_0 20) (= Psi_dot_d_0_0 0) (= Psi_d_0_0 0) (= tau_0_0 0) (= delta_0_0 0) (= Beta_0_0 0) (= Psi_dot_0_0 0) (<= Psi_0_0 0.1) (>= Psi_0_0 0) (= sy_d_0_0 0) (= sx_d_0_0 0) (= v_0_0 11.1) (= sy_0_0 0) (<= sx_0_0 0.5) (>= sx_0_0 0)) (= mode_0 1) (= tau_0_t (+ tau_0_0 (* 1 time_0))) (= sx_env_0_t (+ sx_env_0_0 (* 0 time_0))) (= [Beta_0_t Psi_0_t Psi_d_0_t Psi_dot_0_t Psi_dot_d_0_t delta_0_t kappa_d_0_t sx_0_t sx_d_0_t sx_env_0_t sy_0_t sy_d_0_t tau_0_t v_0_t] (integral 0. time_0 [Beta_0_0 Psi_0_0 Psi_d_0_0 Psi_dot_0_0 Psi_dot_d_0_0 delta_0_0 kappa_d_0_0 sx_0_0 sx_d_0_0 sx_env_0_0 sy_0_0 sy_d_0_0 tau_0_0 v_0_0] flow_1)) (= mode_0 1) (forall_t 1 [0 time_0] (>= sx_0_t 0)) (>= sx_0_t 0) (>= sx_0_0 0) (forall_t 1 [0 time_0] (>= v_0_t 0)) (>= v_0_t 0) (>= v_0_0 0) (= mode_0 1) (> sx_0_t sx_env_0_t) (< sy_0_t 3.7) (< tau_0_t 3.5)))
(check-sat)
(exit)
