...
for round = 1: nRounds
    ...
    for i = 1:nSamplesPerRound
        ...
        for jj = 1:opt.n_workers
            curSample{jj} = chooseBerinoulliSamples(inpRanges, subDivs,distrib);
        end
    ...
    for i = 1:nInputs
        n = subDivs(i,1);
        distrib(i,:) = tiltBerinoulliDistribution(distrib(i,:), sortedSamples(i,:), inpRanges(i,1), inpRanges(i,2), n );
    end
