...
(assert (<= -20 waypointy_1_0))
(assert (<= waypointy_1_0 200))
(assert (<= -20 waypointy_1_t))
(assert (<= waypointy_1_t 200))
(assert (<= -20 waypointy_2_0))
(assert (<= waypointy_2_0 200))
(assert (<= -20 waypointy_2_t))
(assert (<= waypointy_2_t 200))
(assert (<= -20 waypointy_3_0))
(assert (<= waypointy_3_0 200))
(assert (<= -20 waypointy_3_t))
(assert (<= waypointy_3_t 200))
(assert (<= -20 waypointy_4_0))
(assert (<= waypointy_4_0 200))
(assert (<= -20 waypointy_4_t))
(assert (<= waypointy_4_t 200))
(assert (<= -20 waypointx_0_0))
(assert (<= waypointx_0_0 200))
(assert (<= -20 waypointx_0_t))
(assert (<= waypointx_0_t 200))
(assert (<= -20 waypointx_1_0))
(assert (<= waypointx_1_0 200))
(assert (<= -20 waypointx_1_t))
(assert (<= waypointx_1_t 200))
(assert (<= -20 waypointx_2_0))
(assert (<= waypointx_2_0 200))
(assert (<= -20 waypointx_2_t))
(assert (<= waypointx_2_t 200))
(assert (<= -20 waypointx_3_0))
(assert (<= waypointx_3_0 200))
(assert (<= -20 waypointx_3_t))
(assert (<= waypointx_3_t 200))
(assert (<= -20 waypointx_4_0))
(assert (<= waypointx_4_0 200))
(assert (<= -20 waypointx_4_t))
(assert (<= waypointx_4_t 200))
(assert (<= 6 v_0_0))
(assert (<= v_0_0 12))
(assert (<= 6 v_0_t))
(assert (<= v_0_t 12))
...
(assert (<= 0 sy_d_spline_1_0))
(assert (<= sy_d_spline_1_0 10))
(assert (<= 0 sy_d_spline_1_t))
(assert (<= sy_d_spline_1_t 10))
(assert (<= 0 sy_d_spline_2_0))
(assert (<= sy_d_spline_2_0 10))
(assert (<= 0 sy_d_spline_2_t))
(assert (<= sy_d_spline_2_t 10))
(assert (<= 0 sy_d_spline_3_0))
(assert (<= sy_d_spline_3_0 10))
(assert (<= 0 sy_d_spline_3_t))
(assert (<= sy_d_spline_3_t 10))
(assert (<= 0 sy_d_spline_4_0))
(assert (<= sy_d_spline_4_0 10))
(assert (<= 0 sy_d_spline_4_t))
(assert (<= sy_d_spline_4_t 10))
(assert (<= -10 sy_d_0_0))
(assert (<= sy_d_0_0 100))
(assert (<= -10 sy_d_0_t))
(assert (<= sy_d_0_t 100))
...
(assert (<= sx_d_spline_1_0 50))
(assert (<= 0 sx_d_spline_1_t))
(assert (<= sx_d_spline_1_t 50))
(assert (<= 0 sx_d_spline_2_0))
(assert (<= sx_d_spline_2_0 50))
(assert (<= 0 sx_d_spline_2_t))
(assert (<= sx_d_spline_2_t 50))
(assert (<= 0 sx_d_spline_3_0))
(assert (<= sx_d_spline_3_0 50))
(assert (<= 0 sx_d_spline_3_t))
(assert (<= sx_d_spline_3_t 50))
(assert (<= 0 sx_d_spline_4_0))
(assert (<= sx_d_spline_4_0 50))
(assert (<= 0 sx_d_spline_4_t))
(assert (<= sx_d_spline_4_t 50))
(assert (<= -10 sx_d_0_0))
(assert (<= sx_d_0_0 100))
(assert (<= -10 sx_d_0_t))
(assert (<= sx_d_0_t 100))
...
(assert (<= simtime_1_0 5))
(assert (<= 0 simtime_1_t))
(assert (<= simtime_1_t 5))
(assert (<= 0 simtime_2_0))
(assert (<= simtime_2_0 5))
(assert (<= 0 simtime_2_t))
(assert (<= simtime_2_t 5))
(assert (<= 0 simtime_3_0))
(assert (<= simtime_3_0 5))
(assert (<= 0 simtime_3_t))
(assert (<= simtime_3_t 5))
(assert (<= 0 simtime_4_0))
(assert (<= simtime_4_0 5))
(assert (<= 0 simtime_4_t))
(assert (<= simtime_4_t 5))
(assert (<= 0 lookahead_0_0))
(assert (<= lookahead_0_0 100))
(assert (<= 0 lookahead_0_t))
(assert (<= lookahead_0_t 100))
(assert (<= 0 lookahead_1_0))
(assert (<= lookahead_1_0 100))
(assert (<= 0 lookahead_1_t))
(assert (<= lookahead_1_t 100))
(assert (<= 0 lookahead_2_0))
(assert (<= lookahead_2_0 100))
(assert (<= 0 lookahead_2_t))
(assert (<= lookahead_2_t 100))
(assert (<= 0 lookahead_3_0))
(assert (<= lookahead_3_0 100))
(assert (<= 0 lookahead_3_t))
(assert (<= lookahead_3_t 100))
(assert (<= 0 lookahead_4_0))
(assert (<= lookahead_4_0 100))
(assert (<= 0 lookahead_4_t))
(assert (<= lookahead_4_t 100))
...
(assert (<= time_1 3.1 [0.000000]))
(assert (<= 0 time_2 [0.000000]))
(assert (<= time_2 3.1 [0.000000]))
(assert (<= 0 time_3 [0.000000]))
(assert (<= time_3 3.1 [0.000000]))
(assert (<= 0 time_4 [0.000000]))
(assert (<= time_4 3.1 [0.000000]))
(assert (<= 1 mode_0))
(assert (<= mode_0 2))
(assert (<= 1 mode_1))
(assert (<= mode_1 2))
...
(assert (<= 1 mode_4))
(assert (<= mode_4 2))
(assert (and (and (= Psi_dot_d_spline_0_0 0) (= sy_d_spline_0_0 0) (= sx_d_spline_0_0 0) (= Psi_d_spline_0_0 0) (= kappa_d_spline_0_0 0) (= simtime_0_0 0) (= waypointy_0_0 8) (= waypointx_0_0 2) (= Psi_dot_d_0_0 0) (= Psi_d_0_0 0) (= tau_0_0 0) (= delta_0_0 0) (= Beta_0_0 0) (= Psi_dot_0_0 0) (= Psi_0_0 0) (= sy_d_0_0 0) (= sx_d_0_0 0) (= v_0_0 10.9) (= sy_0_0 0) (= sx_0_0 0)) (= mode_0 1) (= waypointy_0_t (+ waypointy_0_0 (* 0 time_0))) (= waypointx_0_t (+ waypointx_0_0 (* 0 time_0))) (= tau_0_t (+ tau_0_0 (* 1 time_0))) (= sy_d_spline_0_t (+ sy_d_spline_0_0 (* 0 time_0))) (= sx_d_spline_0_t (+ sx_d_spline_0_0 (* 0 time_0))) (= simtime_0_t (+ simtime_0_0 (* 1 time_0))) (= lookahead_0_t (+ lookahead_0_0 (* 0 time_0))) (= kappa_d_spline_0_t (+ kappa_d_spline_0_0 (* 0 time_0))) (= Psi_dot_d_spline_0_t (+ Psi_dot_d_spline_0_0 (* 0 time_0))) (= Psi_dot_d_0_t (+ Psi_dot_d_0_0 (* 0 time_0))) (= Psi_d_spline_0_t (+ Psi_d_spline_0_0 (* 0 time_0))) (= [Beta_0_t Psi_0_t Psi_d_0_t Psi_d_spline_0_t Psi_dot_0_t Psi_dot_d_0_t Psi_dot_d_spline_0_t delta_0_t kappa_d_spline_0_t lookahead_0_t simtime_0_t sx_0_t sx_d_0_t sx_d_spline_0_t sy_0_t sy_d_0_t sy_d_spline_0_t tau_0_t v_0_t waypointx_0_t waypointy_0_t] (integral 0. time_0 [Beta_0_0 Psi_0_0 Psi_d_0_0 Psi_d_spline_0_0 Psi_dot_0_0 Psi_dot_d_0_0 Psi_dot_d_spline_0_0 delta_0_0 kappa_d_spline_0_0 lookahead_0_0 simtime_0_0 sx_0_0 sx_d_0_0 sx_d_spline_0_0 sy_0_0 sy_d_0_0 sy_d_spline_0_0 tau_0_0 v_0_0 waypointx_0_0 waypointy_0_0] flow_1)) (= mode_0 1) (forall_t 1 [0 time_0] (>= v_0_t 0)) (>= v_0_t 0) (>= v_0_0 0) (= mode_1 2) (= simtime_0_t 0.1) (= lookahead_1_0 lookahead_0_t) (= simtime_1_0 0) (= waypointy_1_0 0) (= waypointx_1_0 0) (= Psi_dot_d_1_0 Psi_dot_d_0_t) (= sy_d_1_0 sy_0_t) (= sx_d_1_0 sx_d_0_t) (= Psi_d_1_0 Psi_d_0_t) (= delta_1_0 delta_0_t) (= sy_1_0 sy_0_t) (= sx_1_0 sx_0_t) (= v_1_0 v_0_t) (= Psi_dot_1_0 Psi_dot_0_t) (= Psi_1_0 Psi_0_t) (= Beta_1_0 Beta_0_t) (= tau_1_0 tau_0_t) (= Psi_d_spline_0_t Psi_d_spline_1_0) (= Psi_dot_d_spline_0_t Psi_dot_d_spline_1_0) (= kappa_d_spline_0_t kappa_d_spline_1_0) (= sx_d_spline_0_t sx_d_spline_1_0) (= sy_d_spline_0_t sy_d_spline_1_0) (= waypointy_1_t (+ waypointy_1_0 (* 0 time_1))) (= waypointx_1_t (+ waypointx_1_0 (* 0 time_1))) (= v_1_t (+ v_1_0 (* 0 time_1))) (= tau_1_t (+ tau_1_0 (* 0 time_1))) (= sy_d_1_t (+ sy_d_1_0 (* 0 time_1))) (= sy_1_t (+ sy_1_0 (* 0 time_1))) (= sx_d_1_t (+ sx_d_1_0 (* 0 time_1))) (= sx_1_t (+ sx_1_0 (* 0 time_1))) (= simtime_1_t (+ simtime_1_0 (* 1 time_1))) (= lookahead_1_t (+ lookahead_1_0 (* 0 time_1))) (= delta_1_t (+ delta_1_0 (* 0 time_1))) (= Psi_dot_d_1_t (+ Psi_dot_d_1_0 (* 0 time_1))) (= Psi_dot_1_t (+ Psi_dot_1_0 (* 0 time_1))) (= Psi_d_1_t (+ Psi_d_1_0 (* 0 time_1))) (= Psi_1_t (+ Psi_1_0 (* 0 time_1))) (= Beta_1_t (+ Beta_1_0 (* 0 time_1))) (= [Beta_1_t Psi_1_t Psi_d_1_t Psi_d_spline_1_t Psi_dot_1_t Psi_dot_d_1_t Psi_dot_d_spline_1_t delta_1_t kappa_d_spline_1_t lookahead_1_t simtime_1_t sx_1_t sx_d_1_t sx_d_spline_1_t sy_1_t sy_d_1_t sy_d_spline_1_t tau_1_t v_1_t waypointx_1_t waypointy_1_t] (integral 0. time_1 [Beta_1_0 Psi_1_0 Psi_d_1_0 Psi_d_spline_1_0 Psi_dot_1_0 Psi_dot_d_1_0 Psi_dot_d_spline_1_0 delta_1_0 kappa_d_spline_1_0 lookahead_1_0 simtime_1_0 sx_1_0 sx_d_1_0 sx_d_spline_1_0 sy_1_0 sy_d_1_0 sy_d_spline_1_0 tau_1_0 v_1_0 waypointx_1_0 waypointy_1_0] flow_2)) (= mode_1 2) (forall_t 2 [0 time_1] (>= v_1_t 0)) (>= v_1_t 0) (>= v_1_0 0) (= mode_2 1) (= simtime_1_t lookahead_1_t) (= lookahead_2_0 (+ lookahead_1_t 0.2)) (= simtime_2_0 0) (= waypointy_2_0 sy_d_spline_1_t) (= waypointx_2_0 sx_d_spline_1_t) (= Psi_dot_d_2_0 Psi_dot_d_1_t) (= sy_d_2_0 sy_1_t) (= sx_d_2_0 sx_d_1_t) (= Psi_d_2_0 Psi_d_1_t) (= delta_2_0 delta_1_t) (= sy_2_0 sy_1_t) (= sx_2_0 sx_1_t) (= v_2_0 v_1_t) (= Psi_dot_2_0 Psi_dot_1_t) (= Psi_2_0 Psi_1_t) (= Beta_2_0 Beta_1_t) (= tau_2_0 tau_1_t) (= Psi_d_spline_1_t Psi_d_spline_2_0) (= Psi_dot_d_spline_1_t Psi_dot_d_spline_2_0) (= kappa_d_spline_1_t kappa_d_spline_2_0) (= waypointy_2_t (+ waypointy_2_0 (* 0 time_2))) (= waypointx_2_t (+ waypointx_2_0 (* 0 time_2))) (= tau_2_t (+ tau_2_0 (* 1 time_2))) (= sy_d_spline_2_t (+ sy_d_spline_2_0 (* 0 time_2))) (= sx_d_spline_2_t (+ sx_d_spline_2_0 (* 0 time_2))) (= simtime_2_t (+ simtime_2_0 (* 1 time_2))) (= lookahead_2_t (+ lookahead_2_0 (* 0 time_2))) (= kappa_d_spline_2_t (+ kappa_d_spline_2_0 (* 0 time_2))) (= Psi_dot_d_spline_2_t (+ Psi_dot_d_spline_2_0 (* 0 time_2))) (= Psi_dot_d_2_t (+ Psi_dot_d_2_0 (* 0 time_2))) (= Psi_d_spline_2_t (+ Psi_d_spline_2_0 (* 0 time_2))) (= [Beta_2_t Psi_2_t Psi_d_2_t Psi_d_spline_2_t Psi_dot_2_t Psi_dot_d_2_t Psi_dot_d_spline_2_t delta_2_t kappa_d_spline_2_t lookahead_2_t simtime_2_t sx_2_t sx_d_2_t sx_d_spline_2_t sy_2_t sy_d_2_t sy_d_spline_2_t tau_2_t v_2_t waypointx_2_t waypointy_2_t] (integral 0. time_2 [Beta_2_0 Psi_2_0 Psi_d_2_0 Psi_d_spline_2_0 Psi_dot_2_0 Psi_dot_d_2_0 Psi_dot_d_spline_2_0 delta_2_0 kappa_d_spline_2_0 lookahead_2_0 simtime_2_0 sx_2_0 sx_d_2_0 sx_d_spline_2_0 sy_2_0 sy_d_2_0 sy_d_spline_2_0 tau_2_0 v_2_0 waypointx_2_0 waypointy_2_0] flow_1)) (= mode_2 1) (forall_t 1 [0 time_2] (>= v_2_t 0)) (>= v_2_t 0) (>= v_2_0 0) (= mode_3 2) (= simtime_2_t 0.1) (= lookahead_3_0 lookahead_2_t) (= simtime_3_0 0) (= waypointy_3_0 0) (= waypointx_3_0 0) (= Psi_dot_d_3_0 Psi_dot_d_2_t) (= sy_d_3_0 sy_2_t) (= sx_d_3_0 sx_d_2_t) (= Psi_d_3_0 Psi_d_2_t) (= delta_3_0 delta_2_t) (= sy_3_0 sy_2_t) (= sx_3_0 sx_2_t) (= v_3_0 v_2_t) (= Psi_dot_3_0 Psi_dot_2_t) (= Psi_3_0 Psi_2_t) (= Beta_3_0 Beta_2_t) (= tau_3_0 tau_2_t) (= Psi_d_spline_2_t Psi_d_spline_3_0) (= Psi_dot_d_spline_2_t Psi_dot_d_spline_3_0) (= kappa_d_spline_2_t kappa_d_spline_3_0) (= sx_d_spline_2_t sx_d_spline_3_0) (= sy_d_spline_2_t sy_d_spline_3_0) (= waypointy_3_t (+ waypointy_3_0 (* 0 time_3))) (= waypointx_3_t (+ waypointx_3_0 (* 0 time_3))) (= v_3_t (+ v_3_0 (* 0 time_3))) (= tau_3_t (+ tau_3_0 (* 0 time_3))) (= sy_d_3_t (+ sy_d_3_0 (* 0 time_3))) (= sy_3_t (+ sy_3_0 (* 0 time_3))) (= sx_d_3_t (+ sx_d_3_0 (* 0 time_3))) (= sx_3_t (+ sx_3_0 (* 0 time_3))) (= simtime_3_t (+ simtime_3_0 (* 1 time_3))) (= lookahead_3_t (+ lookahead_3_0 (* 0 time_3))) (= delta_3_t (+ delta_3_0 (* 0 time_3))) (= Psi_dot_d_3_t (+ Psi_dot_d_3_0 (* 0 time_3))) (= Psi_dot_3_t (+ Psi_dot_3_0 (* 0 time_3))) (= Psi_d_3_t (+ Psi_d_3_0 (* 0 time_3))) (= Psi_3_t (+ Psi_3_0 (* 0 time_3))) (= Beta_3_t (+ Beta_3_0 (* 0 time_3))) (= [Beta_3_t Psi_3_t Psi_d_3_t Psi_d_spline_3_t Psi_dot_3_t Psi_dot_d_3_t Psi_dot_d_spline_3_t delta_3_t kappa_d_spline_3_t lookahead_3_t simtime_3_t sx_3_t sx_d_3_t sx_d_spline_3_t sy_3_t sy_d_3_t sy_d_spline_3_t tau_3_t v_3_t waypointx_3_t waypointy_3_t] (integral 0. time_3 [Beta_3_0 Psi_3_0 Psi_d_3_0 Psi_d_spline_3_0 Psi_dot_3_0 Psi_dot_d_3_0 Psi_dot_d_spline_3_0 delta_3_0 kappa_d_spline_3_0 lookahead_3_0 simtime_3_0 sx_3_0 sx_d_3_0 sx_d_spline_3_0 sy_3_0 sy_d_3_0 sy_d_spline_3_0 tau_3_0 v_3_0 waypointx_3_0 waypointy_3_0] flow_2)) (= mode_3 2) (forall_t 2 [0 time_3] (>= v_3_t 0)) (>= v_3_t 0) (>= v_3_0 0) (= mode_4 1) (= simtime_3_t lookahead_3_t) (= lookahead_4_0 (+ lookahead_3_t 0.2)) (= simtime_4_0 0) (= waypointy_4_0 sy_d_spline_3_t) (= waypointx_4_0 sx_d_spline_3_t) (= Psi_dot_d_4_0 Psi_dot_d_3_t) (= sy_d_4_0 sy_3_t) (= sx_d_4_0 sx_d_3_t) (= Psi_d_4_0 Psi_d_3_t) (= delta_4_0 delta_3_t) (= sy_4_0 sy_3_t) (= sx_4_0 sx_3_t) (= v_4_0 v_3_t) (= Psi_dot_4_0 Psi_dot_3_t) (= Psi_4_0 Psi_3_t) (= Beta_4_0 Beta_3_t) (= tau_4_0 tau_3_t) (= Psi_d_spline_3_t Psi_d_spline_4_0) (= Psi_dot_d_spline_3_t Psi_dot_d_spline_4_0) (= kappa_d_spline_3_t kappa_d_spline_4_0) (= waypointy_4_t (+ waypointy_4_0 (* 0 time_4))) (= waypointx_4_t (+ waypointx_4_0 (* 0 time_4))) (= tau_4_t (+ tau_4_0 (* 1 time_4))) (= sy_d_spline_4_t (+ sy_d_spline_4_0 (* 0 time_4))) (= sx_d_spline_4_t (+ sx_d_spline_4_0 (* 0 time_4))) (= simtime_4_t (+ simtime_4_0 (* 1 time_4))) (= lookahead_4_t (+ lookahead_4_0 (* 0 time_4))) (= kappa_d_spline_4_t (+ kappa_d_spline_4_0 (* 0 time_4))) (= Psi_dot_d_spline_4_t (+ Psi_dot_d_spline_4_0 (* 0 time_4))) (= Psi_dot_d_4_t (+ Psi_dot_d_4_0 (* 0 time_4))) (= Psi_d_spline_4_t (+ Psi_d_spline_4_0 (* 0 time_4))) (= [Beta_4_t Psi_4_t Psi_d_4_t Psi_d_spline_4_t Psi_dot_4_t Psi_dot_d_4_t Psi_dot_d_spline_4_t delta_4_t kappa_d_spline_4_t lookahead_4_t simtime_4_t sx_4_t sx_d_4_t sx_d_spline_4_t sy_4_t sy_d_4_t sy_d_spline_4_t tau_4_t v_4_t waypointx_4_t waypointy_4_t] (integral 0. time_4 [Beta_4_0 Psi_4_0 Psi_d_4_0 Psi_d_spline_4_0 Psi_dot_4_0 Psi_dot_d_4_0 Psi_dot_d_spline_4_0 delta_4_0 kappa_d_spline_4_0 lookahead_4_0 simtime_4_0 sx_4_0 sx_d_4_0 sx_d_spline_4_0 sy_4_0 sy_d_4_0 sy_d_spline_4_0 tau_4_0 v_4_0 waypointx_4_0 waypointy_4_0] flow_1)) (= mode_4 1) (forall_t 1 [0 time_4] (>= v_4_t 0)) (>= v_4_t 0) (>= v_4_0 0) (= mode_4 1) (> tau_4_t 1)))
(check-sat)
(exit)
